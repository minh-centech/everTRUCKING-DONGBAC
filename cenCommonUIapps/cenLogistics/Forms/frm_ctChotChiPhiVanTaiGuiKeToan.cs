...
namespace cenCommonUIapps.cenLogistics.Forms
{
    public partial class frm_ctChotChiPhiVanTaiGuiKeToan : Form
    {
        ...
        private void cmdChot_Click(object sender, EventArgs e)
        {
            ...
            if (objList.Count > 0)
            {
                if (cenCommon.cenCommon.QuestionMessage("Xác nhận chốt chi phí vận tải những đơn hàng đã chọn?", 0) == DialogResult.Yes)
                {
                ...
                cenCommon.cenCommon.ErrorMessageOkOnly("Không có đơn hàng cần chốt chi phí vận tải!");
        }
        ...
        private void cmdHuyChot_Click(object sender, EventArgs e)
        {
            ...
            if (objList.Count > 0)
            {
                if (cenCommon.cenCommon.QuestionMessage("Xác nhận hủy chốt chi phí vận tải những đơn hàng đã chọn?", 0) == DialogResult.Yes)
                {
                ...
                cenCommon.cenCommon.ErrorMessageOkOnly("Không có đơn hàng cần hủy chốt chi phí vận tải!");
        }
    }
}
