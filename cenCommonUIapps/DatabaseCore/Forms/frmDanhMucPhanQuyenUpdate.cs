...
{
    public partial class frmDanhMucPhanQuyenUpdate : cenBase.BaseForms.frmBaseDanhMucUpdate
    {
        cenDTO.DatabaseCore.DanhMucPhanQuyen obj = null;
        ...
        private bool Save()
        {
            ...
            {
                obj = new cenDTO.DatabaseCore.DanhMucPhanQuyen
                {
                    Ma = txtMa.Value,
                    Ten = txtTen.Value,
                    CreateDate = null,
            ...
            cenBUS.DatabaseCore.DanhMucPhanQuyenBUS _BUS = new cenBUS.DatabaseCore.DanhMucPhanQuyenBUS();
