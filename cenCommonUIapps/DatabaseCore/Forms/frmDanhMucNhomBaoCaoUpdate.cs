...
{
    public partial class frmDanhMucNhomBaoCaoUpdate : cenBase.BaseForms.frmBaseDanhMucUpdate
    {
        cenDTO.DatabaseCore.DanhMucNhomBaoCao obj = null;
        ...
        private bool Save()
        {
            ...
            {
                obj = new cenDTO.DatabaseCore.DanhMucNhomBaoCao
                {
                    Ma = txtMa.Value,
                    Ten = txtTen.Value,
                    CreateDate = null,
            ...
            cenBUS.DatabaseCore.DanhMucNhomBaoCaoBUS _BUS = new cenBUS.DatabaseCore.DanhMucNhomBaoCaoBUS();
