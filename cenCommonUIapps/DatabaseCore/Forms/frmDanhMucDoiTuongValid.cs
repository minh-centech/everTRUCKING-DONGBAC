...
{
    public partial class frmDanhMucDoiTuongValid : Form
    {
        ...
        DanhMucDoiTuongBUS bus;
        public frmDanhMucDoiTuongValid()
        {
            InitializeComponent();
        }
        ...
        private void InsertDanhMuc()
        {
            ...
            if (!cenCommon.cenCommon.IsNull(IDDanhMucLoaiDoiTuong) && !cenCommon.GlobalVariables.isAdmin && !Them)
            {
            ...
            {
                bus = new DanhMucDoiTuongBUS();
                DataTable dtCapNhat = bus.List(frmUpdate.ID, IDDanhMucLoaiDoiTuong, null);
        ...
        private void UpdateDanhMuc()
        {
            if (!cenCommon.cenCommon.IsNull(IDDanhMucLoaiDoiTuong))
                DanhMucPhanQuyenBUS.GetPhanQuyenLoaiDoiTuong(cenCommon.GlobalVariables.IDDanhMucPhanQuyen, IDDanhMucLoaiDoiTuong, out bool Xem, out bool Them, out bool Sua, out bool Xoa);
            if (!cenCommon.cenCommon.IsNull(IDDanhMucLoaiDoiTuong) && !cenCommon.GlobalVariables.isAdmin && !Sua)
            {
