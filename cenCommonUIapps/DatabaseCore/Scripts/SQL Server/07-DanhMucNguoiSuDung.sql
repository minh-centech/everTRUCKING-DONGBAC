...
/*
exec Insert_DanhMucDonVi null, '001', N'DONGBAC', null
go
exec Insert_DanhMucPhanQuyen null, '001', N'Quản trị hệ thống', null
go
--select * from DanhMucPhanQuyen
exec Insert_DanhMucNguoiSuDung null, @IDDanhMucPhanQuyen = 2, @Ma = 'sa', @Ten = N'Quản trị', @Password = N'9OVzDVe/3TQ=', @isAdmin = 1, @CreateDate = null
go
--
exec Insert_DanhMucPhanQuyenDonVi @ID = null, @IDDanhMucPhanQuyen = 2, @IDDanhMucDonVi = 1, @Xem = 1, @CreateDate = null
go
---
*/
